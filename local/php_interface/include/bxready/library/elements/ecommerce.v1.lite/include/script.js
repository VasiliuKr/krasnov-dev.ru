if (window){
    window.catalogEcommerceV1Lte = {
        ...
        $('.bxr-ecommerce-v1-lite[data-resize=1]').each(function(){
...
//    };
    ...
    BXReady.Market.loader.push(catalogEcommerceV1Lte.resizeVerticalBlock);
    ...
    $(document).on("mouseover", ".bxr-ecommerce-v1-lite .bxr-trade-request", function() {
        ...
        strParams = "";
        $(this).closest('.bxr-ecommerce-v1-lite').find('li.bx_active').each(function() {
