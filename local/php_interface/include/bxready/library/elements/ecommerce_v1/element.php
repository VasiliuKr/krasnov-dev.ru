...
$showCatalogQty = ('Y' == $arElementParams["SHOW_CATALOG_QUANTITY"]);
	?><div class="bxr-ecommerce-v1" data-uid="<?=$UID?>" data-resize="1"<?=($arItemIDs["ID"] > 0)?' id="'.$arItemIDs["ID"].'"':''?>>
		<div class="bxr-element-container">
			<div class="bxr-element-image"><?
				...
				?><a href="<?=$arElement["DETAIL_PAGE_URL"]?>">
                                    <img src="<?=$picture["src"]?>"<?=(strlen($arItemIDs["PICT"]) > 0)?' id="'.$arItemIDs["PICT"].'"':''?> alt="<?=$alt?>" title="<?=$title?>">
                                </a>
			</div>
			...
			?><div class="bxr-element-rating">
					<div class="bxr-stars-container">
                        ...
                        if ($showCatalogQty) {
                            ?><div class="bxr-element-avail"<?=(strlen($arItemIDs["AVAIL"]) > 0 )?' id="'.$arItemIDs["AVAIL"].'"':''?>>
                                    <?include('avail.php');?>
                            </div><?
                        }
