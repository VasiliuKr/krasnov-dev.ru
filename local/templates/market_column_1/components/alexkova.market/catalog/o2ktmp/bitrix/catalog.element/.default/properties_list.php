                ...
                if (!is_array($arProperty["DISPLAY_VALUE"]) && $arProperty["DISPLAY_VALUE"]){?>
                        <tr itemprop="additionalProperty" itemscope itemtype="http://schema.org/PropertyValue">
                                ...
                                <td class="bxr-props-data">
                                    <?if ($gostElements[$arProperty["DISPLAY_VALUE"]]):?>
                                        <a href="<?=SITE_DIR.'gost/'.$gostElements[$arProperty['DISPLAY_VALUE']].'/'?>"><span itemprop="value"><?=$arProperty["DISPLAY_VALUE"]?></span></a>
                                    <?else:?>
                                        <span itemprop="value"><?=$arProperty["DISPLAY_VALUE"]?></span>
                                        <?if( $key == 'SIZE_LENGTH' || $key == 'SIZE_WIDTH' || $key == 'SIZE_DEPTH' ):?>
                                            мм
                                        <?endif?>
                                    <?endif;?>
                                </td>
