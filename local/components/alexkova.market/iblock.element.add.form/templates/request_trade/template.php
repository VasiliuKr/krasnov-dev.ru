							...
							case "N":
								...
								?>
                                                                ...
                                                                <?if ($inputType != 'textarea') {?>
                                                                    ...
                                                                    <?}?>
                                                                <?} else {?>
                                                                        <textarea name="PROPERTY[<?=$propertyID?>][<?=$i?>]" rows="5" data-code="<?=$arResult["PROPERTY_LIST_FULL"][$propertyID]["CODE"]?>" style="resize: none">
                                                                        <?=$value?>
                                                                    </textarea><br /><br />
                                                                <?}?>
...
<script>
    $(function() {
       $('textarea[data-code="USER_COMMENT_AREA"]').html(formRequestMsg); 
       ...
       if (parseInt(current_offer_id) > 0)
