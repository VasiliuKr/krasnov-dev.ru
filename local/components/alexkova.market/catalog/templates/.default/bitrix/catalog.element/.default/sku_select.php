    ...
    <div class="bxr-sku-select-wrap" data-pid="<?=$chosenColor["ID"]?>">
        ...
        <ul class="bxr-sku-select-items">
			...
			?>
                        ...
                        <span class="bxr-offer-props-name"><?=substr($offer["NAME"], strlen($arResult["NAME"]))?> - <?=CurrencyFormat($arPrice['DISCOUNT_VALUE'], $arPrice['CURRENCY'])." / "?><?=$arResult["CATALOG_MEASURE_NAME"]?></span><?=$propStr?>
                    </div>
                    <div class="clearfix"></div>
                </li>
            <?endforeach;?>
