...
//    
    ...
    "SUBMENU_DESCRIPTION" => array(
        "PARENT" => "MENU_BLOCKS",
        "NAME" => GetMessage("SUBMENU_DESCRIPTION"),
        "TYPE" => "CHECKBOX",
        "DEFAULT" => "Y",
    ),
    
    "SUBMENU_PICTURE" => array(
        "PARENT" => "MENU_BLOCKS",
        "NAME" => GetMessage("SUBMENU_PICTURE"),
        "TYPE" => "CHECKBOX",
        "DEFAULT" => "Y",
    ),
    
    "SUBMENU_PICTURE_SECTION" => array(
        "PARENT" => "MENU_BLOCKS",
        "NAME" => GetMessage("SUBMENU_PICTURE_SECTION"),
        "TYPE" => "LIST",
        "VALUES" => $arPictureSection,
        "DEFAULT" => "N",
    )    
